...
module Dero::Processor::SensitiveMasker
  extend self
  ...
  def fields_re
    ...
    default_fields = Dero::Configuration::DEFAULT_MASKED_FIELDS
    ...
    fields_list_str = used_fields.map do |f|
      Dero::Processor.use_boundary?(default_fields, f) ? "\\b#{f}\\b" : f
    end.join("|")
  ...
  def sanitize_query_string(query_string)
    ...
    Dero::Processor::Utf8.process!(query_hash)
    process!(query_hash)
...
end # Dero::Processor::SensitiveMasker
